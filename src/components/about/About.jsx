...
const About = () => {
  return (
    <div id="about" className='About'>
      ...
      <div className="grid-abt-container">
      <p data-aos='fade-right' data-aos-duration="2000" className='Aboutp'>
      • I'm an ambitious <span className='bold'>engineering</span> student from Barrie, Ontario
      </p>
      <p data-aos='fade-left' data-aos-duration="2000" className='Aboutp1'>
      • I have a keen eye for detail and a natural aptitude for <span className='bold'>problem-solving</span>. 
      </p>
      <p data-aos='fade-right' data-aos-duration="2000" className='Aboutp2'>
      ...
      <p data-aos='fade-left' data-aos-duration="2000" className='Aboutp3'>
      ...
      <p data-aos='fade-right' data-aos-duration="2000" className='Aboutp4'>
